...
import Game.Entities.Dynamics.Boss;
...
public class Handler {
	...
	public BaseHostileEntity newEnemy(BufferedImage[] images,Handler handler, int xPosition, int yPosition, String state, String name, String area,
		...
		if(typeOfEnemy.equals("EnemyOne")) {
			...
			Boss n = new Boss(handler, xPosition, yPosition, state, name, area,images);
			n.setAcc(acc);
			n.setBuffs(buffs);
			n.setClass(Class);
			n.setCons(cons);
		...
		else if(typeOfEnemy.equals("sBoss")) {
			SBoss n = new SBoss(handler, xPosition, yPosition, state, name, area,images);
			n.setAcc(acc);
			n.setBuffs(buffs);
			n.setClass(Class);
			n.setCons(cons);
	...
	public BaseNPCEntity newNPC(BufferedImage[] images,Handler handler, int xPosition, int yPosition, String state, String name, String area,
			String typeOfEnemy) {
		NPC n = new NPC(handler, xPosition, yPosition, state, name, area,images);
		return n;
