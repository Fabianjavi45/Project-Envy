...
public class CaveArea extends BaseArea {
    ...
    public CaveArea(Handler handler, EntityManager entityManager) {
        ...
        this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdle,handler,700, 2000,"InWorldState","Dark Grunt","Cave","EnemyOne",100,25,80,15,8,12,20,10,20,10,1,10,"None","Thunder",null,null)); //lvl 2 difficulty
        this.entityManager.AddEntity(handler.newEnemy(Images.PEnemyIdle,handler,3000, 1000,"InWorldState","Dark Grunt","Cave","EnemyOne",100,25,60,15,1,12,20,10,20,13,1,10,"None","Thunder",null,null)); // lvl 1 difficulty
    ...
    public void tick() {
        ...
        if(Player.GruntCount==2) {
        	handler.getGame().getMusicHandler().playEffect("res/music/SSAcquired.wav",1);
        	caveWalls.add(new InWorldWalls(handler, 661, 140, 60, 80, "S Exit"));
        	Player.GruntCount=0;
        	Player.CaveQuest=true;
        }
