...
public class Boss extends BaseHostileEntity implements Fighter{

    Rectangle Boss;
    int width, height;

    public Boss(Handler handler, int xPosition, int yPosition, String state, String name, String area, BufferedImage[] animFrames) {
    ...
    public void render(Graphics g) {
        ...
        if(handler.getArea().equals(this.Area)) {
            ...
            Boss = new Rectangle((int) (handler.getXDisplacement() + getXOffset()),
                        (int) (handler.getYDisplacement() + getYOffset()), 70, 70);

            g2.setColor(Color.black);
          
            	g.drawImage(Images.Primal,Boss.x,Boss.y,Boss.width,Boss.height,null);
