...
public class Images {
	...
	public static BufferedImage QuestLog;
	public static BufferedImage QCLog;
	public static BufferedImage Primal;
	public static BufferedImage RayBoss;


	public static SpriteSheet playerSheet;
	public static SpriteSheet NPCSheet;
	public static BufferedImage[] player_front;
	public static BufferedImage[] player_left;
	public static BufferedImage[] player_right;
	public static BufferedImage[] player_back;
	public static BufferedImage[] NPC_front;
	public static BufferedImage player_attack;

	public static BufferedImage[] PEnemyIdle;
	public static BufferedImage[] QEnemyIdle;
	public static BufferedImage[] BEnemyIdle;
	public static BufferedImage[] WEnemyIdle;

	public static SpriteSheet PEnemySheet;
	public static SpriteSheet QEnemySheet;
	public static SpriteSheet BEnemySheet;
	...
	public static BufferedImage SkillNone;
	...
	public static BufferedImage Dusk;
	public static BufferedImage Ray;
	public static BufferedImage CDoor;
	...
	public Images() {
		...
		NPC_front = new BufferedImage[4];
		

		PEnemyIdle = new BufferedImage[7];
		QEnemyIdle = new BufferedImage[7];
		BEnemyIdle= new BufferedImage[7];
		...
		try {
			...
			PEnemySheet = new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/DuskullSheet.png")));
			QEnemySheet= new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/DialgaSS.png")));
			BEnemySheet= new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/Ray Sheet.png")));
			...
			ghost = ImageIO.read(getClass().getResourceAsStream("/Sheets/Duskull.png"));
			Primal= ImageIO.read(getClass().getResourceAsStream("/Sheets/Dialga.png"));
			QuestLog = ImageIO.read(getClass().getResourceAsStream("/Sheets/Quest Log.png"));
			QCLog = ImageIO.read(getClass().getResourceAsStream("/Sheets/QCLog.png"));


			CaveMap = ImageIO.read(getClass().getResourceAsStream("/Worlds/CaveMap.png"));
			TownMap= ImageIO.read(getClass().getResourceAsStream("/Worlds/EnVy Town.png"));
			CastleMap= ImageIO.read(getClass().getResourceAsStream("/Worlds/CastleMap.png"));
			tree = ImageIO.read(getClass().getResourceAsStream("/Sheets/Tree.png"));
			Dusk= ImageIO.read(getClass().getResourceAsStream("/Sheets/Dusknoir.png"));
			Ray= ImageIO.read(getClass().getResourceAsStream("/Sheets/Ray.png"));
			CDoor=ImageIO.read(getClass().getResourceAsStream("/Sheets/CastleDoor.png"));
			...
			SkillNone= ImageIO.read(getClass().getResourceAsStream("/Sheets/SkillNone.png"));
			...
			battleBackground[4] = ImageIO.read(getClass().getResourceAsStream("/Sheets/CastleBackground.png"));
			...
			PEnemyIdle[0] = PEnemySheet.crop(0, 0, 43, 45);
			PEnemyIdle[1] = PEnemySheet.crop(43, 0, 43, 45);
			PEnemyIdle[2] = PEnemySheet.crop(87, 0, 42, 45);
			PEnemyIdle[3] = PEnemySheet.crop(131, 0, 40, 45);
			PEnemyIdle[4] = PEnemySheet.crop(172, 0, 42, 45);
			PEnemyIdle[5] = PEnemySheet.crop(214, 0, 43, 45);
			PEnemyIdle[6] = PEnemySheet.crop(0, 0, 43, 45);
			
			QEnemyIdle[0] = QEnemySheet.crop(0, 0, 96, 96);
			QEnemyIdle[1] = QEnemySheet.crop(96, 0, 96, 96);
			QEnemyIdle[2] = QEnemySheet.crop(192, 0, 96, 96);
			QEnemyIdle[3] = QEnemySheet.crop(288, 0, 96, 96);
			QEnemyIdle[4] = QEnemySheet.crop(384, 0, 96, 96);
			QEnemyIdle[5] = QEnemySheet.crop(0, 96, 96, 96);
			QEnemyIdle[6] = QEnemySheet.crop(96, 96, 96, 96);
			
			BEnemyIdle[0]= BEnemySheet.crop(0, 0, 110, 97);
			BEnemyIdle[1]= BEnemySheet.crop(109, 0, 110, 97);
			BEnemyIdle[2]= BEnemySheet.crop(218, 0, 110, 97);
			BEnemyIdle[3]= BEnemySheet.crop(327, 0, 110, 97);
			BEnemyIdle[4]= BEnemySheet.crop(0, 102, 110, 97);
			BEnemyIdle[5]= BEnemySheet.crop(109, 102, 110, 97);
			BEnemyIdle[6]= BEnemySheet.crop(218, 102, 110, 97);
			...
			NPCSheet =  new SpriteSheet(ImageIO.read(getClass().getResourceAsStream("/Sheets/QuestNPC.png")));
			
			NPC_front[0]=NPCSheet.crop(0,0,42,54);
			NPC_front[1]=NPCSheet.crop(66,0,42,54);
			NPC_front[2]=NPCSheet.crop(0,0,42,54);
			NPC_front[3]=NPCSheet.crop(131,0,42,54);
...
//		
		...
		ScaledTown= Images.TownMap.getScaledInstance(3200, 3200,Image.SCALE_SMOOTH);	// 320x320 pixel image
		ScaledCastle= Images.CastleMap.getScaledInstance(5790, 5600,Image.SCALE_SMOOTH); 	//579x560 pixel image
